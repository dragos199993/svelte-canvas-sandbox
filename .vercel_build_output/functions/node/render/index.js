...
var require_package = __commonJS({
  "node_modules/websocket/package.json"(exports, module2) {
    module2.exports = {
      ...
      _spec: "1.0.34",
      _where: "/home/dragos/Personal/onemenu",
      author: {
        name: "Brian McKelvey",
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-add177d7.js",
      css: [assets + "/_app/assets/start-464e9d0a.css"],
      js: [assets + "/_app/start-add177d7.js", assets + "/_app/chunks/vendor-78de171c.js", assets + "/_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    {
      type: "page",
      pattern: /^\/auth\/activate-account\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/auth/__layout.svelte", "src/routes/auth/activate-account.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/auth/__layout.svelte", "src/routes/auth/register.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/auth\/login\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/auth/__layout.svelte", "src/routes/auth/login.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/auth/activate-account.svelte": () => Promise.resolve().then(function() {
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-8476c9fa.js", "css": ["assets/pages/__layout.svelte-2e8329d5.css"], "js": ["pages/__layout.svelte-8476c9fa.js", "chunks/vendor-78de171c.js", "chunks/db-26c0b30b.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-577af656.js", "css": [], "js": ["error.svelte-577af656.js", "chunks/vendor-78de171c.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-2f482d4f.js", "css": [], "js": ["pages/index.svelte-2f482d4f.js", "chunks/vendor-78de171c.js"], "styles": [] }, "src/routes/dashboard/__layout.svelte": { "entry": "pages/dashboard/__layout.svelte-3371118b.js", "css": [], "js": ["pages/dashboard/__layout.svelte-3371118b.js", "chunks/vendor-78de171c.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js", "chunks/db-26c0b30b.js"], "styles": [] }, "src/routes/dashboard/index.svelte": { "entry": "pages/dashboard/index.svelte-341227c2.js", "css": [], "js": ["pages/dashboard/index.svelte-341227c2.js", "chunks/vendor-78de171c.js", "chunks/db-26c0b30b.js"], "styles": [] }, "src/routes/contact.svelte": { "entry": "pages/contact.svelte-18954b06.js", "css": [], "js": ["pages/contact.svelte-18954b06.js", "chunks/vendor-78de171c.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-1e5be34a.js", "css": [], "js": ["pages/about.svelte-1e5be34a.js", "chunks/vendor-78de171c.js"], "styles": [] }, "src/routes/auth/__layout.svelte": { "entry": "pages/auth/__layout.svelte-33cc3cd6.js", "css": [], "js": ["pages/auth/__layout.svelte-33cc3cd6.js", "chunks/vendor-78de171c.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js", "chunks/db-26c0b30b.js"], "styles": [] }, "src/routes/auth/activate-account.svelte": { "entry": "pages/auth/activate-account.svelte-30c548ed.js", "css": [], "js": ["pages/auth/activate-account.svelte-30c548ed.js", "chunks/vendor-78de171c.js", "chunks/db-26c0b30b.js"], "styles": [] }, "src/routes/auth/register.svelte": { "entry": "pages/auth/register.svelte-fc566087.js", "css": [], "js": ["pages/auth/register.svelte-fc566087.js", "chunks/vendor-78de171c.js", "chunks/db-26c0b30b.js"], "styles": [] }, "src/routes/auth/login.svelte": { "entry": "pages/auth/login.svelte-456b21c9.js", "css": [], "js": ["pages/auth/login.svelte-456b21c9.js", "chunks/vendor-78de171c.js", "chunks/db-26c0b30b.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js"], "styles": [] } };
...
var supabase = (0, import_supabase_js.createClient)("https://xeiivqxiqrwvgxitcpvp.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYzMjgzMzQyMiwiZXhwIjoxOTQ4NDA5NDIyfQ.L7fVaCRENvd_XoyTKfXTSC_DKbKtYMh_9JBHihYK8iA");
var userStore = writable(supabase.auth.currentUser);
...
var Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_user();
  return `<nav class="${"bg-white border-gray-200"}"><div class="${"px-2 sm:px-4 lg:px-5"}"><div class="${"flex items-center justify-between h-16"}">
			<div class="${"flex items-center sm:justify-start"}"><a href="${"/"}"><img src="${"/docs/images/logo.svg"}" class="${"h-10 mr-4"}" alt="${"FlowBite Logo"}"></a>
				<div class="${"hidden sm:block sm:ml-6"}"><ul class="${"flex space-x-8"}">${$user ? `<li><a href="${"/dashboard"}" class="${"text-gray-700 hover:text-blue-700 text-sm font-medium"}" aria-current="${"page"}">Dashboard</a></li>` : ``}
						<li><a href="${"#"}" class="${"text-gray-700 hover:text-blue-700 text-sm font-medium"}">Services</a></li>
						<li><a href="${"/contact"}" class="${"text-gray-700 hover:text-blue-700 text-sm font-medium"}">Contact</a></li></ul></div></div>
			<div class="${"flex items-center sm:static sm:inset-auto sm:ml-6"}">${escape((_a = $user == null ? void 0 : $user.email) != null ? _a : "")}
				${$user ? `<button type="${"button"}" class="${"text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 mr-3 text-center inline-flex items-center"}">Log out
					</button>
					
					<button type="${"button"}" class="${"bg-gray-800 flex text-sm rounded-full focus:ring-4 focus:ring-gray-300"}" id="${"user-menu-button"}" aria-expanded="${"false"}" data-dropdown-toggle="${"dropdown"}"><span class="${"sr-only"}">Open user menu</span>
						<img class="${"h-8 w-8 rounded-full"}" src="${"/docs/images/people/profile-picture-3.jpg"}" alt="${"user photo"}"></button>` : `<a href="${"/auth/register"}" class="${"rounded-lg border border-gray-200 bg-white text-sm font-medium px-4 py-2 text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 mr-3 mb-3"}">Register
					</a>
					<a href="${"/auth/login"}" class="${"text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 mb-3"}">Log in</a>`}
				
				<button data-collapse-toggle="${"mobile-menu-2"}" type="${"button"}" class="${"sm:hidden ml-3 text-gray-400 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-300 rounded-lg inline-flex items-center justify-center"}" aria-controls="${"mobile-menu-2"}" aria-expanded="${"false"}"><span class="${"sr-only"}">Open main menu</span>
	...
	<div class="${"sm:hidden hidden"}" id="${"mobile-menu-2"}"><ul class="${"pt-2"}"><li><a href="${"#"}" class="${"bg-gray-100 text-gray-900 text-base font-normal block pl-3 pr-4 py-2"}">Dashboard</a></li>
			<li><a href="${"#"}" class="${"text-gray-600 hover:bg-gray-50 border-b border-gray-100 text-base font-normal hover:border-gray-300 hover:text-gray-900 block px-3 py-2"}">Team</a></li>
			<li><a href="${"#"}" class="${"text-gray-600 hover:bg-gray-50 border-b border-gray-100 text-base font-normal hover:border-gray-300 hover:text-gray-900 block px-3 py-2"}">Projects</a></li>
			<li><a href="${"#"}" class="${"text-gray-600 hover:bg-gray-50 text-base font-normal hover:border-gray-300 hover:text-gray-900 block px-3 py-2"}">Calendar</a></li></ul></div></nav>`;
});
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"container"}"><div class="${"w-full flex items-center flex-col"}"><h1 class="${"pb-8 text-red-400"}">Welcome to SvelteKit</h1>
		...
		<div class="${"flex bg-red-100 rounded-lg p-4 mb-4"}"><svg class="${"w-5 h-5 text-red-700"}" fill="${"currentColor"}" viewBox="${"0 0 20 20"}" xmlns="${"http://www.w3.org/2000/svg"}"><path fill-rule="${"evenodd"}" d="${"M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"}" clip-rule="${"evenodd"}"></path></svg>
			<p class="${"ml-3 text-sm text-red-700"}"><span class="${"font-medium"}">Important Note!</span> Change a few things up and try submitting again.
			</p></div></div></div>`;
});
...
var Dashboard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"container"}"><div class="${"w-full flex items-center flex-col"}"><button type="${"button"}" class="${"text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 mb-3"}">Default</button></div></div>`;
});
...
var Contact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"container"}"><div class="${"w-full flex items-center flex-col"}"><form class="${"mt-8"}"><div class="${"mb-6"}"><label for="${"email"}" class="${"text-sm font-medium text-gray-900 block mb-2"}">Your email</label>
				<input type="${"email"}" id="${"email"}" class="${"bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"}" placeholder="${"name@company.com"}" required></div>
			<div class="${"mb-6"}"><label for="${"password"}" class="${"text-sm font-medium text-gray-900 block mb-2"}">Your password</label>
				<input type="${"password"}" id="${"password"}" class="${"bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"}" required></div>
			<div class="${"flex items-start mb-6"}"><div class="${"flex items-center h-5"}"><input id="${"remember"}" aria-describedby="${"remember"}" type="${"checkbox"}" class="${"bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded"}" required></div>
				<div class="${"text-sm ml-3"}"><label for="${"remember"}" class="${"font-medium text-gray-900"}">Remember me</label></div></div>
			<button type="${"submit"}" class="${"text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"}">Submit</button></form></div></div>`;
});
...
var Activate_account = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `8
<div class="${"container"}"><div class="${"w-full flex items-center flex-col"}"><div class="${"w-full sm:w-1/2 lg:w-4/12 px-8 sm:px-0 flex justify-center flex-col items-center"}"><h1 class="${"pt-32 text-center text-2xl font-bold"}">An activation email has been sent.</h1>
			<h1 class="${"pt-4 text-center text-xl"}">In order to access your account, you need to access the link received on your email.
			</h1>

			<a href="${"/auth/login"}" class="${"text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:ring-gray-300 mt-8 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 mb-3"}">Log in</a></div></div></div>`;
});
var activateAccount = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
...
<div class="${"container"}"><div class="${"w-full flex items-center flex-col"}"><div class="${"w-full sm:w-1/2 lg:w-4/12 xl:w-3/12 px-8 sm:px-0"}"><h1 class="${"pt-32 text-center text-2xl font-bold"}">Create a new account</h1>
			<form class="${"mt-8"}">${``}
				<div class="${"mb-6"}"><label for="${"email"}" class="${"text-sm font-medium text-gray-900 block mb-2"}">Your email</label>
					<input type="${"email"}" id="${"email"}" class="${"bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"}" required${add_attribute("value", email, 0)}></div>
				<div class="${"mb-6"}"><label for="${"password"}" class="${"text-sm font-medium text-gray-900 block mb-2"}">Your password</label>
					<input type="${"password"}" id="${"password"}" class="${"bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"}" required${add_attribute("value", password, 0)}></div>
				<div class="${"mb-6"}"><label for="${"password_confirm"}" class="${"text-sm font-medium text-gray-900 block mb-2"}">Password confirm</label>
					<input type="${"password"}" id="${"password_confirm"}" class="${"bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"}" required${add_attribute("value", password_confirm, 0)}></div>
				<div class="${"flex justify-end"}"><button type="${"submit"}" class="${"text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"}">Register</button></div></form></div></div></div>`;
});
...
<div class="${"container"}"><div class="${"w-full flex items-center flex-col"}"><div class="${"w-full sm:w-1/2 lg:w-4/12 xl:w-3/12 px-8 sm:px-0"}"><h1 class="${"pt-32 text-center text-2xl font-bold"}">Log in</h1>
			<form class="${"mt-8"}">${``}
				<div class="${"mb-6"}"><label for="${"email"}" class="${"text-sm font-medium text-gray-900 block mb-2"}">Your email</label>
					<input type="${"email"}" id="${"email"}" class="${"bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"}" required${add_attribute("value", email, 0)}></div>
				<div class="${"mb-6"}"><label for="${"password"}" class="${"text-sm font-medium text-gray-900 block mb-2"}">Your password</label>
					<input type="${"password"}" id="${"password"}" class="${"bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"}" required${add_attribute("value", password, 0)}></div>
				<div class="${"flex justify-end"}"><button type="${"submit"}" class="${"text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"}">Log in</button></div></form></div></div></div>`;
});
